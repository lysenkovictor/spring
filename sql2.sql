...
(
    ...
    CONSTRAINT `fk_t_operation_t_item1`
        FOREIGN KEY (`item_id`)
...
(
    ...
    PRIMARY KEY (`t_category_id`, `t_item_id`),
    INDEX           `fk_t_category_has_t_item_t_item1_idx` (`t_item_id` ASC) VISIBLE,
    INDEX           `fk_t_category_has_t_item_t_category1_idx` (`t_category_id` ASC) VISIBLE,
    CONSTRAINT `fk_t_category_has_t_item_t_category1`
        FOREIGN KEY (`t_category_id`)
